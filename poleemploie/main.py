...
class PoleEmploie(threading.Thread):
    ...
    def __init__(self, setting):
        ...
        self.list_jobs_url = f"https://candidat.pole-emploi.fr/offres/recherche?lieux=11R&motsCles={self.keywords[random.randint(0, len(self.keywords)-1)]}&offresPartenaires=true"
        options = Options()
